...
public enum SubsystemManagerStates implements SubsystemStates {
	IDLE("Idle", () -> ElevatorStates.IDLE, CoralerStates.IDLE, AlgaerStates.IDLE, () -> AutoAlignStates.OFF, () -> LEDStates.IDLE, ClimberStates.DOWN, PassthroughStates.OFF),
	CLIMBING("Climbing", () -> ElevatorStates.IDLE, CoralerStates.IDLE, AlgaerStates.IDLE, () -> AutoAlignStates.OFF, () -> LEDStates.CLIMBING, ClimberStates.UP, PassthroughStates.OFF),
	INTAKING_ALGAE_GROUND("Intaking Algae Ground", () -> ElevatorStates.IDLE, CoralerStates.IDLE, AlgaerStates.INTAKING, () -> AutoAlignStates.OFF, () -> LEDStates.ALGAE, ClimberStates.DOWN, PassthroughStates.OFF),
	INTAKING_ALGAE_LOW("Intaking Algae Low", () -> ElevatorStates.ALGAE_LOW, CoralerStates.IDLE, AlgaerStates.INTAKING, () -> AutoAlignStates.OFF, () -> LEDStates.ALGAE, ClimberStates.DOWN, PassthroughStates.OFF),
	INTAKING_ALGAE_HIGH("Intaking Algae High", () -> ElevatorStates.ALGAE_HIGH, CoralerStates.IDLE, AlgaerStates.INTAKING, () -> AutoAlignStates.OFF, () -> LEDStates.ALGAE, ClimberStates.DOWN, PassthroughStates.OFF),
	GOING_PROCESSOR("Going to Processor", () -> ElevatorStates.ALGAE_PROCESSOR, CoralerStates.IDLE, AlgaerStates.GOING_TO_PROCESS, () -> AutoAlignStates.OFF, () -> LEDStates.ALGAE, ClimberStates.DOWN, PassthroughStates.OFF),
	SCORING_PROCESSOR("Scoring at Processor", () -> ElevatorStates.ALGAE_PROCESSOR, CoralerStates.IDLE, AlgaerStates.PROCESSING, () -> AutoAlignStates.OFF, () -> LEDStates.ALGAE, ClimberStates.DOWN, PassthroughStates.OFF),
	HOLDING_ALGAE("Holding Algae", () -> ElevatorStates.ALGAE_PROCESSOR, CoralerStates.IDLE, AlgaerStates.HOLDING_ALGAE, () -> AutoAlignStates.OFF, () -> LEDStates.ALGAE, ClimberStates.DOWN, PassthroughStates.OFF),
	AUTO_ALIGN_CLOSE(
		"Aligning Close",
	...
	ZEROING_ELEVATOR("Zeroing Elevator", () -> ElevatorStates.ZEROING, CoralerStates.IDLE, AlgaerStates.IDLE, () -> AutoAlignStates.OFF, () -> LEDStates.IDLE, ClimberStates.DOWN, PassthroughStates.OFF);

	SubsystemManagerStates(String stateString, Supplier<ElevatorStates> elevatorStateSupplier, CoralerStates coralerState, AlgaerStates algaerState, Supplier<AutoAlignStates> autoAlignSupplier, Supplier<LEDStates> ledStateSupplier, ClimberStates climberState, PassthroughStates passthroughState) {
