...
public enum SubsystemManagerStates implements SubsystemStates {
	...
	AUTO_ALIGN_FAR("Aligning Far", () -> ElevatorStates.TRANSITIONING, CoralerStates.IDLE, AlgaerStates.IDLE, () -> REEF_TARGET_MAP.get(AAReefTarget.of(SubsystemManager.getInstance().getHexagonTargetSide(), SubsystemManager.getInstance().getScoringReefLeft())), () -> LEDStates.AUTOALIGN, ClimberStates.DOWN),
	INTAKING_CORALER(
