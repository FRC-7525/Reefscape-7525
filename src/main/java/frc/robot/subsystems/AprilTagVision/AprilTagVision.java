...
public class AprilTagVision extends SubsystemBase {
	...
	private AprilTagVision() {
		...
		visionPoseEstimators = new CameraPoseEstimator[] {
			new CameraPoseEstimator(new PhotonCamera(FRONT_CAMERA_NAME), ROBOT_TO_FRONT_CAMERA, POSE_STRATEGY, CameraResolution.HIGH_RES),
			new CameraPoseEstimator(new PhotonCamera(BACK_CAMERA_NAME), ROBOT_TO_BACK_CAMERA, POSE_STRATEGY, CameraResolution.HIGH_RES),
		};
