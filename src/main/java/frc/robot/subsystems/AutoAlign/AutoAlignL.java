...
public class AutoAlignL extends Subsystem<AutoAlignStates> {

	private static AutoAlignL instance;
	...
	public static AutoAlignL getInstance() {
		if (instance == null) {
			instance = new AutoAlignL();
		}
		return instance;
	}
