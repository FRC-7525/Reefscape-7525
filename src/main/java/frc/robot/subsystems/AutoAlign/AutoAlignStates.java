...
public enum AutoAlignStates implements SubsystemStates {
	...
	L1("Driving to Reef Left 1", PosePair.of(new Pose2d(14.409, 3.869, Rotation2d.fromDegrees(180)), new Pose2d(3.165, 4.163, Rotation2d.fromDegrees(0))), Meters.of(.5)),
	R1("Driving to Reef Right 1", PosePair.of(new Pose2d(14.407, 4.197, Rotation2d.fromDegrees(180)), new Pose2d(3.165, 3.841, Rotation2d.fromDegrees(0))), Meters.of(0.5)),
	L2("Driving to Reef Left 2", PosePair.of(new Pose2d(13.869, 5.105, Rotation2d.fromDegrees(240)), new Pose2d(3.710, 2.948, Rotation2d.fromDegrees(60))), Meters.of(0.5)),
	R2("Driving to Reef Right 2", PosePair.of(new Pose2d(13.562, 5.264, Rotation2d.fromDegrees(240)), new Pose2d(3.995, 2.783, Rotation2d.fromDegrees(60))), Meters.of(0.5)),
	L3("Driving to Reef Left 3", PosePair.of(new Pose2d(12.540, 5.209, Rotation2d.fromDegrees(300)), new Pose2d(5.028, 2.812, Rotation2d.fromDegrees(120))), Meters.of(0.5)),
	R3("Driving to Reef Right 3", PosePair.of(new Pose2d(12.253, 5.048, Rotation2d.fromDegrees(300)), new Pose2d(5.312, 2.972, Rotation2d.fromDegrees(120))), Meters.of(0.5)),
	L4("Driving to Reef Left 4", PosePair.of(new Pose2d(11.717, 4.156, Rotation2d.fromDegrees(0)), new Pose2d(5.813, 3.872, Rotation2d.fromDegrees(180))), Meters.of(0.5)),
	R4("Driving to Reef Right 4", PosePair.of(new Pose2d(11.717, 3.828, Rotation2d.fromDegrees(0)), new Pose2d(5.813, 4.199, Rotation2d.fromDegrees(180))), Meters.of(0.5)),
	L5("Driving to Reef Left 5", PosePair.of(new Pose2d(12.271, 2.928, Rotation2d.fromDegrees(60)), new Pose2d(5.272, 5.102, Rotation2d.fromDegrees(240))), Meters.of(0.5)),
	R5("Driving to Reef Right 5", PosePair.of(new Pose2d(12.558, 2.764, Rotation2d.fromDegrees(60)), new Pose2d(4.987, 5.262, Rotation2d.fromDegrees(240))), Meters.of(0.5)),
	L6("Driving to Reef Left 6", PosePair.of(new Pose2d(13.602, 2.793, Rotation2d.fromDegrees(120)), new Pose2d(3.952, 5.244, Rotation2d.fromDegrees(300))), Meters.of(0.5)),
	R6("Driving to Reef Right 6", PosePair.of(new Pose2d(13.912, 2.964, Rotation2d.fromDegrees(120)), new Pose2d(3.666, 5.080, Rotation2d.fromDegrees(300))), Meters.of(0.5)),
