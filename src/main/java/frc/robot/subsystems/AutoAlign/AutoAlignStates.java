...
public enum AutoAlignStates implements SubsystemStates {
	...
	L1_1("Driving to Reef 1 for L1", PosePair.of(new Pose2d(11.71934, 4.0125, Rotation2d.fromDegrees(7)), new Pose2d(3.15, 4.013, Rotation2d.fromDegrees(7))), Meters.of(0.5)),
	L1_2("Driving to Reef 2 for L1", PosePair.of(new Pose2d(12.38907, 2.8525, Rotation2d.fromDegrees(62)), new Pose2d(3.81973, 2.8525, Rotation2d.fromDegrees(62))), Meters.of(0.5)),
	L1_3("Driving to Reef 3 for L1", PosePair.of(new Pose2d(13.72851, 2.8525, Rotation2d.fromDegrees(122)), new Pose2d(5.15918, 2.8525, Rotation2d.fromDegrees(122))), Meters.of(0.5)),
	L1_4("Driving to Reef 4 for L1", PosePair.of(new Pose2d(14.39824, 4.0125, Rotation2d.fromDegrees(182)), new Pose2d(5.8289, 4.0125, Rotation2d.fromDegrees(182))), Meters.of(0.5)),
	L1_5("Driving to Reef 5 for L1", PosePair.of(new Pose2d(13.72851, 5.1725, Rotation2d.fromDegrees(242)), new Pose2d(5.15918, 5.1725, Rotation2d.fromDegrees(242))), Meters.of(0.5)),
	L1_6("Driving to Reef 6 for L1", PosePair.of(new Pose2d(12.38907, 5.1725, Rotation2d.fromDegrees(302)), new Pose2d(3.81973, 5.1725, Rotation2d.fromDegrees(302))), Meters.of(0.5)),
