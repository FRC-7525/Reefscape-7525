...
public final class ElevatorConstants {
	...
	public static final LinearVelocity MAX_VELOCITY = InchesPerSecond.of(5);
	public static final LinearAcceleration MAX_ACCELERATION = InchesPerSecond.per(Second).of(5);
