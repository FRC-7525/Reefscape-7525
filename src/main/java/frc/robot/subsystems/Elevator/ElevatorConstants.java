...
public final class ElevatorConstants {
	...
	public static final LinearAcceleration MAX_ACCELERATION = InchesPerSecond.per(Second).of(40);
	...
	public static class Sim {
		...
		public static final PIDConstants PROFILLED_PID_CONSTANTS = new PIDConstants(10, 3, 1, 0.5);
	...
	public static class Real {
		...
		public static final Current LEFT_STRATOR_CURRENT_LIMIT = Amps.of(90);
		...
		public static final Current RIGHT_STRATOR_CURRENT_LIMIT = Amps.of(90);
