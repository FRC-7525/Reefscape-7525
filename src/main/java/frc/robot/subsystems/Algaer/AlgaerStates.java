...
public enum AlgaerStates implements SubsystemStates {
	INTAKING(
		"INTAKING",
		AlgaerConstants.INTAKING_SPEED,
		AlgaerConstants.INTAKING_PIVOT
	),
	OUTTAKING(
		"OUTAKKING",
		AlgaerConstants.OUTTAKING_SPEED,
		AlgaerConstants.OUTTAKING_PIVOT
	),
	PASSING(
		"PASSING",
		AlgaerConstants.PASSING_SPEED,
		AlgaerConstants.PASSING_PIVOT
	),
