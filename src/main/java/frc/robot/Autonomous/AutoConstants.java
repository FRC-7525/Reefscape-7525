...
public class AutoConstants {
	...
	public static Distance calculateVerticalCG(Distance elevatorHeight, Distance carriageHeight) {
		...
		Distance zCG = Meters.of(CHASSIS_MASS.in(Kilograms) * chassisCG.in(Meters) + ELEVATOR_MASS.in(Kilograms) * elevatorCG.in(Meters) + CARRIAGE_MASS.in(Kilograms) * carriageCG.in(Meters)).div(TOTAL_MASS_LBS.in(Kilograms));
